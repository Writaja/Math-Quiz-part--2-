...
function check(){
    ...
    if(ans==word){
        if(ans_turn=="player1"){
            ...
            number1_score=number2_score+1
            document.getElementById("number1_score").innerHTML=number2_score;
        }    }
        if(question_turn=="number1"){
            question_turn="number2"
            document.getElementById("question_number").innerHTML="question turn - "+number2_name;
        ...
        if(ans_turn=="number1"){
            ans_turn="number2"
            document.getElementById("player_ans").innerHTML="answer turn - "+number1_name;

        }
else{
    ans_number="number1";
    document.getElementById("ans-number").innerHTML="answer turn - "+number1_name;
}
document.getElementById("output").innerHTML="";    
}
